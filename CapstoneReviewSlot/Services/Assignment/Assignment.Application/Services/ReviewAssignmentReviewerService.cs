...
public class ReviewAssignmentReviewerService : IReviewAssignmentReviewerService
{
    ...
    public ReviewAssignmentReviewerService(
        IReviewAssignmentReviewerRepository repository,
    ...
    public async Task<List<ReviewAssignmentReviewerDto>> AddAsync(List<ReviewAssignmentReviewerDto> reviewers)
    {
        ...
        {
            throw ErrorHelper.BadRequest("Phải assign đúng 2 reviewers cho mỗi group.");
        }
        ...
        {
            await _validator.ValidateAddReviewerAsync(reviewer);
